...
import { TrendingUp, ChevronRight, ChevronLeft, LogOut } from "lucide-react";
...
export const Sidebar: React.FC = React.memo(() => {
  ...
  return (
    <>
      {!collapsed && (
        <div
          className="fixed inset-0 z-40 bg-black/30 backdrop-blur-sm h-full"
          onClick={() => {
            setCollapsed(true);
          }}
        />
      ...
      >
        ...
        <div className="px-2 pb-4 border-t border-border pt-4 space-y-1 shrink-0">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-text-muted hover:text-expense hover:bg-expense/10 transition-all duration-150 group ${collapsed ? "justify-center" : "justify-baseline"}`}
          >
